#!/usr/bin/env python3
"""
Convert dataset (Office/Industrial_and_Scientific) to MiniTwoRec format with semantic IDs
"""
...
def convert_interactions_to_csv(splits: Dict[str, List], items: Dict[str, Dict], 
    ...
    """Convert interaction data to MiniTwoRec CSV format using semantic IDs"""
...
def main():
    parser = argparse.ArgumentParser(description='Convert dataset (Office_Products/Industrial_and_Scientific) to MiniTwoRec format with semantic IDs')
    ...
    parser.add_argument('--output_dir', type=str,
                       help='Output directory for MiniTwoRec format data')
    ...
    print(f"You can now use these files with MiniTwoRec training scripts by setting category='{args.category}'")
